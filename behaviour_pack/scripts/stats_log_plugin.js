...
export function log_block_event(event_type, player, block, block_id, guild_id) {
    const mainhand = player.getComponent(EntityComponentTypes.Equippable).getEquipment(EquipmentSlot.Mainhand);
    var mainhand_arg = '';
    if (mainhand) {
        var mainhand_arg = `&mainhand=${mainhand.typeId}`;
    }
...
export function log_kill_event(player, killed_entity, guild_id) {
    const mainhand = player.getComponent(EntityComponentTypes.Equippable).getEquipment(EquipmentSlot.Mainhand);
    var mainhand_arg = '';
    if (mainhand) {
        var mainhand_arg = `&mainhand=${mainhand.typeId}`;
...
export function log_death_event(player, killer_entity, guild_id) {
    const mainhand = player.getComponent(EntityComponentTypes.Equippable).getEquipment(EquipmentSlot.Mainhand);
    var mainhand_arg = '';
    if (mainhand) {
        var mainhand_arg = `&mainhand=${mainhand.typeId}`;
...
export function log_self_death_event(player, cause, guild_id) {
    const mainhand = player.getComponent(EntityComponentTypes.Equippable).getEquipment(EquipmentSlot.Mainhand);
    var mainhand_arg = '';
    if (mainhand) {
        var mainhand_arg = `&mainhand=${mainhand.typeId}`;
...
export function log_player_death_event(player, killer_player, guild_id) {
